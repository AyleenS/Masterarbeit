...
zwischen zwei Systemen deren Äquivalenz beweisen.\\ \TODO{falls möglich
passendes Quellen Beispiel einfügen}\\
...
\begin{Def}[schwache alternierende Simulation]
  ...
  w"=as"=Implementierungen von $Q$ verwendet. \TODO{ausführen oder
  umformulieren}
\end{Def}
