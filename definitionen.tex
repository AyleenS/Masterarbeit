...
\begin{Def}[Modal Interface Error-I/O-Transitionssystem]
  ...
  \begin{itemize}
    ...
    \item $\must{} \subseteq P\times (A\cup\{\tau\})\times
      P$%\footnote{$\mathcal{P}(P)$ bezeichnet die Potenzmenge von $P$}
...
\TODO{ab hier Transitionen nicht zu Mengen, sondern zu einem Zustand umändern}
...
werden als durchgezogener %, möglicherweise aufspaltender, 
Pfeil gezeichnet
...
\begin{Def}[Parallelprodukt]
  ...
  E)$ definiert mit: \TODO{erzwungenen Zeilenumbruch kontrollieren}
  \begin{itemize}
