...
\begin{proof}\mbox{}\\
  ...
  \begin{itemize}
    \item Fall 1 ($w\in\PrET (P)$): Es existiert ein $v\in O_P$, sodass das
      ...
      oder eine lokale Aktion ist, kann mit~\ref{wSimDef}.4 bzw.~\ref{wSimDef}.5
    ...
    \item Fall 2 ($w\in\MIT (P)$): $w$ ist in $P$ ein Input-kritischer Trace.
      ...
      auf~\ref{wSimDef}.4 bzw.~\ref{wSimDef}.5 kann daraus gefolgert werden, dass die
  ...
  hier~\ref{wSimDef}.4 und~\ref{wSimDef}.5 dazu verwendet werden einen analogen Trace in
