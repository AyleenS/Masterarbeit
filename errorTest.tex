...
\begin{proof}
  ...
  Gleichheit $\ET _{P'_1\|T} = \cont (\prune ((\ET _{P'_1}\|\EL _T)\cup (\EL
  _{P'_1}\|\ET _T)))$. $\varepsilon$ ist auf jeden Fall präfix-minimal, das
  \cont{} hat also keinen Einfluss. Mit Proposition~\ref{KommSemProp} folgt
  $\varepsilon \in \prune ((\ET _1\|\EL _T)\cup (\EL _1\|\ET _T))$. Es gibt
  also ein $w\in O_{P_1\|T}^*$, dass in der Menge $\ET _1\|\EL _T$ oder in der
  Menge $\EL _1\|\ET _T$ enthalten ist. Es gibt also Wörter $w_1$ und $w_T$ mit
  $w\in w_1\|w_T$, $w_1\in \ET _1$ bzw.\ $w_1\in\EL _1$ und $w_T\in\EL _T$
  bzw.\ $w_T \in\ET _T$. Da $P_1\ERel P_2$ gilt, folgt $w_1\in \ET _2$ bzw.\
  $w_1\in \EL _2$. Es gibt durch Proposition~\ref{KommSemProp} eine
  as"=Implementierung $P'_2$ von $P_2$ für die $w_1\in\ET _{P'_2}$ bzw.\
  $w_1\in\ET _{P'_2}$ gilt. In Parallelkomposition mit $T$ ist das Wort $w$
  also in der Menge $(\ET _{P'_2}\|\EL _T)\cup (\EL _{P'_2}\|\ET _T)$
  enthalten. $P_1$ und $P_2$ müssen die gleiche Signatur besitzen, es gilt also
  auch $w\in O_{P'_2\|T}$ und somit $\varepsilon\in\prune ((\ET _{P'_2}\|\EL
  _T)\cup (\EL _{P'_2}\|\ET _T))) \subseteq \ET _{P'_2\|T}$. Es ist also in
  $P'_2\|T$ ein Fehler lokal erreichbar und es folgt für die Spezifikation
  $P_2$ $\neg P_2 \EsatAs T$.
\end{proof}
