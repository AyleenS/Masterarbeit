...
\begin{proof}
  ...
  ((\ET _1\|\EL _T)\cup (\EL _1\|\ET _T))$. Es gibt also ein $w\in
  O_{P_1\|T}^*$, dass in der Menge $\ET _1\|\EL _T$ oder in der Menge $\EL
  _1\|\ET _T$ enthalten ist. Es gibt also Wörter $w_1$ und $w_T$ mit $w\in
  ...
  _2$. Es gibt aufgrund von Proposition~\ref{KommSemProp} eine
