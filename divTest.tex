...
\begin{proof}
  ...
  einer der drei folgenden Mengen ist: $\ET _{P'_1\|T}$, $\DT _{P'_1\|T}$ oder
  $\StQT _{P'_1\|T}$.
  \begin{itemize}
    \item Fall 1 ($w\in\ET _{P'_1\|T}$): Dieser Fall kann analog zu Fall 1 aus
      Satz~\ref{StilleTestVerfSatz} auf den Beweis von
      Satz~\ref{KommTestVerfSatz} zurückgeführt werden. Es gibt also eine
      as"=Implementierung $P'_2$ von $P_2$, die in Komposition mit $T$ einen
      Fehler lokal erreicht. Daraus folgt $\neg P_2\DsatAs T$.
    \item Fall 2 ($w\in\DT _{P'_1\|T}$): \TODO{zu beweisen}
    \item Fall 3 ($w\in\StQT _{P'_1\|T}$): \TODO{zu beweisen}
  \end{itemize}
