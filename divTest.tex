...
\begin{proof}\mbox{}
  \begin{enumerate}
    \item Um diese Inklusion beweisen zu können wird wieder eine
      ...
      p_2, \dots , p_n: \hat{w'} = w \land w' = \alpha _1\alpha _2\dots\alpha
...
ein Partner ist. Zur Vereinfachung von umständlichen wird Formulierungen im
Folgenden hierfür nun ein neuer Begriff definiert, der jedoch bereits als
    ...
    \item Fall 2 ($w=x_1\dots x_n x_{n+1}\in\Sigma ^+$ mit $n\geq 0$ und
      ...
      \begin{itemize}
        ...
        \item Fall 2iii) ($\varepsilon\in\DT (P'_2\|T)$): Da $T$ keine
          ...
          $P'_2$ geerbt sein. $T$ hat $x_1\dots x_iv$ ausgeführt mit $v\in (O
          \cup \{\chi\})^*$ und ebenso hat $P'_2$ den Weg $x_1\dots
          x_iv|_{\Sigma _2}$ ausgeführt. Durch dies hat $P'_2$ einen Zustand
          aus $Div_{P'_2}$ erreicht. Es gilt dann $\prune (x_1\dots
          x_iv|_{\Sigma _2}) = \prune (x_1\dots x_i)\in\PrDT _{P'_2} \subseteq
