...
divergenz-triviale Form. Damit dies möglich ist, müssen die betrachteten
...
\begin{proof}[Beweis zu Satz~\ref{DivSemSatz}]\mbox{}\\
  ...
  _P$ und $\EDL _P = \EL _P$. Somit lassen sich die hier zu beweisende Aussagen
  auf die des Satzes~\ref{StilleSemSatz} reduzieren.
  ...
  \begin{enumerate}
    ...
    \item $\begin{aligned}[t]
        ...
        &\hspace{0.1cm}\overset{1.}{=} (\QET _{\DF (P_1)}\|\QET _{\DF
        (P_2)})\cup \EDT _{12}\\
    ...
    \item $\begin{aligned}[t]
        ...
        &\hspace{0.1cm}\overset{1.}{=} (\EL _{\DF (P_1)}\|\EL _{\DF (P_2)})\cup
        \EDT _{12}\\
        &\overset{\ref{QDRelDivNormLem}}{=} (\EL _1\|\EL _2)\cup \EDT _{12}\\
