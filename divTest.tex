...
\begin{proof}\mbox{}
  \begin{enumerate}
    \item Um diese Inklusion beweisen zu können wird wieder eine
      ...
      Relation. Zusätzlich mit der Implementierung aller Transitionen aus $P$
...
\begin{proof}[Beweis zu Satz~\ref{DivSemSatz}]\mbox{}\\
  ...
  \begin{itemize}
    ...
    \item Fall 2 ($w\in \PrDT _{12}$): Es gibt eine Verlängerung $v\in O_{12}$,
      ...
      Komposition beteiligten Zustand aufweisen. Das andere System muss nur den
      auf sein Teilsystem projizierten Trace von $wv$ ausführen können. Die
      ...
      Systems komponiert. Das Wort $wv$, dass dabei entsteht, ist also in $\ET
  ...
  oder $w_j$ ist erst durch die Normierung zu einem fortgesetzten gekürzten
    ...
    \item Fall 2 ($w_j\in\DT _j$): \OBdA{} $j=1$. $w_2$ ist in der Menge $\EL
      ...
      \begin{itemize}
        \item Fall 2a) ($w_2\in\MIT _2$): Es gibt ein Präfix von $w_1$, dass
          ...
          Synchronisations"=Problemen wegen des nicht sichergestellten Input in
          ...
          den Synchronisations"=Problemen führt ausführbar ist und somit in der
  ...
  (ii):
  Man kann diese Gleichheit wieder in zwei Inklusionen aufteilen, die jedoch
  ...
  \subseteq\QET (\DF (P_{12}))$. Da die Konstruktion der Normierung auf
  ...
  bereits die Gleichheit für die Einschränkung. Es wird also direkt $L (\DF
