...
\begin{proof}
  ...
  Für $n=0$ gibt es keine $\alpha$s und $p_0\mathcal{R} q_0$ folgt direkt aus
  der Voraussetzung, das $\mathcal{R}$ eine schwache
  as"=Verfeinerungs"=Relation für $P$ und $Q$ ist.\\
...
Dieser Punkt wird in einem späteren Kapitel für unendliche $\tau$-Abläufe
bezüglich Divergenz relevant.
...
\begin{Kor}[unendliche Abläufe in as-Verfeinerungen und Spezifikationen]
  ...
  Anfangsstück des Ablaufes, das in $Q$ einen Fehler"=Zustand erreicht.
\end{Kor}
