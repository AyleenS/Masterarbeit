...
Abläufen in as"=Verfeinerungen und ihren Spezifikationen benötigt. Um nicht
immer wieder ähnliche Argumentationen zu benötigen, wird diese Aussage nun hier
allgemein bewiesen.
...
\begin{Prop}[Abläufe in as-Verfeinerungen und Spezifikationen]
  ...
  es gibt wird ein $p_j$ für $0\leq j < n$ erreicht, dass in der Menge $E_P$
