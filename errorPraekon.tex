...
\begin{proof}
  ...
  somit könne die Fälle 1 und 2 unverändert übernommen werden. Für Fall 3
  ...
  Lemma der Graphentheorie
  \textbf{TODO: Literaturverweis}
  .
  Dieser Punkt wird in einem späteren Kapitel für
  unendliche $\tau$-Abläufe bezüglich Divergenz relevant.
  \\ \TODO{Quelle für Königs Lemma (Petrinetze Vorlesung, keine unendlichen
  Verzweigungen/lokal endlich)}
\end{proof}
