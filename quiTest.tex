...
\begin{proof}
  ...
  \QET{}_{32}$ folgt, wegen der Defintion von \QRel{} in~\ref{StilleSemDef}.
...
\end{Satz}
\begin{proof}
  \TODO{analog zum entsprechendn Satz des Fehler-Kapitels umformulieren}
  Nach Definition gilt $w\in\QET (P)$ mit $w\in O_P^*$ genau dann, wenn in $P$
