...
\begin{proof}
  ...
  $a\in\Sigma$ gilt somit, wenn in $P$ für einen Zustand $p$ $p\nmust[a]$, gilt
  auch in $P'$ $p' \nmust[a]$ für den Zustand, der mit $p$ in Relation steht.
  Der Startzustand von $P'$ ist mit $\varepsilon$ erreichbar und ebenfalls
  ruhig. Es gilt also $p'_0\in Qui (P')$ und $\varepsilon\in\StQT (P')$. Der
  2.\ Punkt der Definition~\ref{SimDef} ist für die Identitäts-Relation als
  ...
  \{\varepsilon\}$. Falls $\varepsilon$ zu einem Ruhe-Zustand $p \neq p_0$ in
  $P$ geführt hat, gilt sogar $\StQT(P) = \StQT (P')$, da ein Trace aus
  internen Aktionen in $P$ und $P'$ zu dem entsprechenden ruhigen Zustand $p$
  bzw.\ $q$ führt.
\end{proof}
