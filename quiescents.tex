...
\begin{proof}\mbox{}
  \begin{enumerate}
    ...
    \item Es gilt $(p_1,p_2)\in Qui_{12}\backslash E_{12}$, somit hat dieser
      ...
      \begin{itemize}
        \item Fall 1 \big($p_1\must[\tau]$\big): Da die Transition für $P_1$
        ...
        \item Fall 2 \big($p_1\must[a]$ mit $a\in O_1\backslash
          ...
          Parallelkomposition übernommen. Es müsste alle $(p_1,p_2)\must[a]$
          mit $a\in O_{12}$ gelten, was jedoch verboten ist. Somit kann die
          Transition für $P_1$ in diesem Fall nicht möglich sein.
        \item Fall 3 \big($p_1\must[a]$ mit $a\in O_1\cap\Synch(P_1,P_2)$ und
          $p_2\must[a]$\big): In diesem Fall ist die Synchronisation des
        ...
        \item Fall 4 \big($p_1\must[a]$ mit $a\in O_1\cap\Synch(P_1,P_2)$ und
          $p_2\nmust[a]$\big): Da $P_2$ die $a$ Transition nicht als
...
\begin{proof}
  ...
  $(p_{01},p_{02})\weakmay[w](p_1,p_2)$ gilt mit $(p_1,p_2)\in
  Qui_{12}\backslash E_{12}$. Durch Projektion erhält man $p_{01}\weakmay[w_1]
  p_1$ und $p_{02}\weakmay[w_2]p_2$ mit $w\in w_1\|w_2$. Aus $(p_1,p_2)\in
