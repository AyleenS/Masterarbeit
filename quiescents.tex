...
\begin{Kor}[lokale Ruhe Erreichbarkeit]\mbox{}
  ...
  \begin{enumerate}[(i)]
    ...
    \item Falls in einem \MEIO{} $P$ einen lokal erreichbaren Ruhe-Zustand
      ...
      Ruhe-Zustand lokal erreichbar ist.
...
\begin{proof}\mbox{}
  \begin{enumerate}[(i)]
    ...
    \item Da ein Ruhe-Zustand in $P$ lokal erreichbar ist, gilt $w\in \StQT
      _P$ für $w\in O$. Es muss wegen Proposition~\ref{RuheTraceProp}
      mindestens ein $P'\in \asimp (P)$ geben, für dass $w\in \StQT _{P'}$
      gilt. Da $w$ nur aus lokalen Aktion bestehen kann, ist auch in $P'$ ein
      Ruhe-Zustand lokal erreichbar.
    \item Sei $P'$ die as"=Implementierung von $P$, in der ein Fehler- oder
      Ruhe-Zustand lokal erreichbar ist. Es gilt dann $w\in \QET _{P'}$ für
      $w\in O$. Mit Proposition~\ref{RuheSemProp} folgt draus $w\in \QET _P$.
      Es muss also auch in $P$ ein Fehler- oder Ruhe-Zustand lokal erreichbar
      sein.
  \end{enumerate}
\end{proof}
...
\begin{proof}
  ...
  wegen~\ref{lokaleRuheErrKor}. Es gilt dann auch, dass $P'_j\|T$ einen lokal
  erreichbaren Fehler oder lokal erreichbare Ruhe hat, wenn $P'_j$ dies hat,
  ...
  Ruhe-Zustand. In der Parallelkomposition der as"=Implementierung mit einem
  ...
  Parallelkomposition auf. Bei Ruhe hingegen zeigt sich das \glqq
  ...
  \Rightarrow P_1 \QsatAs T$ und somit Ruhe-verfeinert $P_1$ $P_2$.
\end{proof}
...
\begin{Satz}[Zusammenhang der Verfeinerungs-Relationenen mit der Ruhe-Relation]
  \label{ZusammenhRuheSatz}
...
\begin{proof}\mbox{}\\
  ...
  wird davon ausgegangen, das $w$ in $Q$ ohne das erreichben eines
