...
\begin{proof}\mbox{}\\
  ...
  $(p_1,p_2)$ kein Kommunikatiosfehler sein kann, da $\ET _{12}\subseteq\EDT
  ...
  \begin{itemize}
    \item Fall 1 ($w_1\in\EDT _1\lor w_2\in\EDT _2$): \OBdA{} gilt $w_1\in\EDT
      ...
      Daraus kann mit dem ersten Punkt dieses Satztes gefolgert werden, dass
    ...
    \item Fall 2 ($w_1\in\StQT _1\backslash\EDT _1\land w_2\in\StQT
      _2\backslash\EDT _2$): Dieser Fall läft analog zu Fall 2 derselben
      Inkulusionsrighung des Beweises von Satz~\ref{RuheSemSatz}. Hierfür muss
