...
\begin{proof}
  ...
  \begin{enumerate}
    \item Es gilt für diesen Punkt nicht unbedingt, dass $(p'_1,p'_2)$ kein
      ...
      werden. Jedoch stellt dies eine stärkere Forderung. Auf Implementierungen
      ist die Forderung stärkere, wie die auf \EIO{}s in
    ...
    \item Aus der Definition der schwachen alternierenden
      ...
      \begin{itemize}
        \item Fall 1 ($i\notin\Synch (P_1\|P_2)$): \OBdA{} ist $i$ in $I_1$
          ...
          der Definition von $\mathcal{R}_{12}$ kann dann daraus
        ...
        \item Fall 2 ($i\in\Synch (P_1\|P_2)$): Damit $i$ auch in $P_1\|P_2$
          ...
          $\mathcal{R}_{12}$. Durch die Synchronisation der $i$-Inputs und
          Verschränkung der $\tau$-Transitionen in der Komposition von $P'_1$
          und $P'_2$ gilt $(p'_1,p'_2) \must[i]_{P'_1\|P'_2}
...
Für schwache as"=Implementierungen kann kein analoges Korollar
