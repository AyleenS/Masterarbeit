...
\begin{proof}
  ...
  \begin{enumerate}
    \item Dieser Punkt kann im Gegensatz zu 1.\ aus dem Beweis von
      ...
      ein neuer Fehler-Zustand sein. Dafür müsste dafür entweder
      $p'_1\nmust[a]_{P'_1}$ und $p_2\may[a]_2$ für ein $a$ aus $I_1\cap O_2$
      oder $p'_1\may[a]_{P'_1}$ und $p_2\nmust[a]_2$ für ein $a$ aus $O_1\cap
      I_2$ gelten. Mit~\ref{SimDef}~2.\ von $\mathcal{R}_1$ folgt im Fall $a\in
      I_1$ $p_1 \nmust[a]_1$. $\mathcal{R}_1$ erzwingt mit~\ref{SimDef}~3.\ die
      Ausführbarkeit des Outputs $a$ in $P_1$ im Fall $a\in O_1$, d.h.\ $p_1
      \may[a]_1$. Somit müsste auch $(p_1,p_2)\in E_{12}$ in beiden Fällen
    ...
    \item $\alpha$ kann sowohl Input, Output wie auch interen Aktion sein. Um
      ...
      Lemma~\ref{schwVerfParallelLem} kombinieren. Da $\mathcal{R}_1$ für die
      Transition in den $P'_1$ ohne zusätzliche $\tau$-Transitionen fordern,
