    ...
    \item Analog zu 2.\ kann für diesen Punkt $(p_1,p_2) \must[\omega]_{12}
      ...
      \begin{itemize}
        \item Fall 1 ($\omega\notin\Synch (P_1,P_2)$): Der Fall $\omega$ ist
          ...
          werden, dass $p'_1 \weakmust[\hat{\omega}]_{P'_1} q'_1$ mit
