...
\begin{Lem}[w-as-Verfeinerung und Parallelkomposition]
  ...
  \\ \TODO{zur technischen Aussage für die Punkte 2.-5.\ umwandeln}
\end{Lem}
\begin{proof}
  ...
  \begin{enumerate}
    \item Für den ersten Punkt ist zu zeigen, dass $(p'_1,p'_2)$ kein Element
      ...
      gilt $(p'_1,p'_2)\notin E_{P'_1\|P'_2}$.
      \\ \TODO{Punkt entfernen und Output, der Synchronisation nur schwach
      erfordert als Gegenbeispiel einfügen}
...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \item Hierfür werden die Punkte 3.\ und 4.\ aus dem Beweis des
      ...
      also ebenfalls.
  \end{enumerate}
  \TODO{Argumentation an die technische Aussage für die schwache Verfeinerung
  anpassen}
\end{proof}
