...
Die Transitionen, die mit einem Outputs beschriftet sind, der in der Menge $L$
...
ausführbar. Auch für schwache must"=Transtionen ändert sich nur die
Beschriftung, jedoch nicht die Ausführbarkeit.

\begin{Lem}[schwache must-Transitionen unter Hiding]
  Sei $P$ ein \MEIO{}, $L\cap I = \emptyset$ und $o\in L \cap O$. Falls $p
  \weakmust[o]_P p'$ gilt, folgt die Gültigkeit von $p
  \weakmust[\varepsilon]_{P/L} p'$.
\end{Lem}
\begin{proof}
  \TODO{zu beweisen}
\end{proof}
