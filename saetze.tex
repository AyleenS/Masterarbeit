...
\begin{Bem}[w-as-Verfeinerung und Parallelkomposition]
...
\begin{proof}
  ...
  für $P'_1\|P_2$ und $P_1\|P_2$ geben, da $P'_1\|P_2 \mathcal{R} P_1\|P_2$ nur
  gilt, wenn\TODO{beenden}
  ...
  stärkere, wie die der \EIO{}s in z.B.~\cite{Schinko2016BA}. Dieser Ansatz
  käme jedoch dem Vorgehen des Abschneidens der Fehler-Zustände mit ihren
  lokalen Vorgängern in~\cite{Vogler2016MIA3} näher.
