...
\begin{Def}[Kommunikationsfehler-Traces]
  ...
  \begin{itemize}
    ...
    \item \emph{Input-kritische-Traces}: $\MIT (P) := \left\{wa\in\Sigma ^* \mid
      ...
      \right\}$ \TODO{erzwungen Zeilenumbruch kontrollieren}
  \end{itemize}
\end{Def}
...
\begin{proof}
  ...
  %   \end{itemize}
  % \item \TODO{in diesem Fall as-Implementierung/Implementierung prüfen} Fall 2 ($w\in\PrET _{12}$): Aus der Definition von \PrET{} und \prune{}
