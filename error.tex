...
\begin{proof}
  ...
  \MIT _{12}$ entahlten und somit gilt $x\in \ET _{12}$, da \ET{} die
  ...
  \begin{itemize}
    \item Fall 1 ($v_1=\varepsilon$): Da $\varepsilon\in\PrET _1\cup \MIT _1$,
      ...
      (möglicherweise auch via may"=Trantistionen). $\varepsilon \in \MIT _1$
  ...
  $a\notin I_2$ gefolgert weden, dass $p_{02} \weakmust[v'_2]$ gilt.
